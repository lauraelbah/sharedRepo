...
public class FSharpGbmajor implements chordSound {

    private final Player player = new Player();
    private final String s1 = "A#5w";
    private final String s2 = "C#5w";
    private final String s3 = "F#5w";
    private final String s4 = "A#5w";

    @Override
    public void playNotes(){
        Pattern pattern = new Pattern("T300 I[Guitar] Ri A#5i C#5i F#5i A#5w");
        player.play(pattern);
    }
